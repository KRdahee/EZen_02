                     ...
                     <div class="div_showcons">
                        <div class="div_condetail">
                           ...
                           <input type="hidden" name="userid" value="${loginUser.userid}"> 
                              <h1 class="h1_name">${loginUser.userid}</h1>
                              <input type="image" style="cursor:pointer; margin-right " height="30px" src="${pageContext.request.contextPath}/img/watcha/setting.jpg" alt="전송">
                        </form>
                           </div>
