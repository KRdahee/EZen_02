									...
									<c:if test="${!empty loginUser.userid}">
										<a class="rep_contents">
											<form name="frm" method="post" action="BoardServlet">
												<input type="hidden" name="command" value="board_reply_list">
												<input type="hidden" name="rno" value="${board.num}">
												...
												<div class="commbox">
													<ul class="ul_comm">
														<div class="comm_one">
															...
															<c:if test="${reply.userid eq loginUser.userid }">
															<form name="frm" method="post" action="BoardServlet">
															<input type="hidden" name="command" value="reply_delete_board">
															<input type="hidden" name="movietitle" value="${Movie.title}">
															<input type="hidden" name="replyuserid" value="${reply.userid}">
															<input type="hidden" name="replycontents" value="${reply.contents}">
															<input type="hidden" name="replycode" value="${reply.code}">
															<input type="hidden" name="num" value="${board.num}">
															
															<input type="submit" name="댓글 삭제" value="댓글 삭제">
															</form>
															</c:if>
														</div>
													</ul>
