...
import com.saeyan.controller.action.board.BoardReplyList;
...
import com.saeyan.controller.action.member.DeleteReplyBoard;
import com.saeyan.controller.action.member.DeleteReplyMovie;
import com.saeyan.controller.action.member.DeleteReplyTV;
...
import com.saeyan.controller.action.tv.TVReply;
...
public class ActionFactory {
	...
	public Action getAction(String command) {
		...
		if (command.equals("board_list")) {
			...
			action = new DeleteReplyMovie();
		} else if (command.equals("reply_delete_tv")) { 
			action = new DeleteReplyTV();
		} else if (command.equals("tv_reply")) { 
			action = new TVReply();
		} else if (command.equals("board_reply_list")) { 
			action = new BoardReplyList();
		}  else if (command.equals("reply_delete_board")) { 
			action = new DeleteReplyBoard();
		}
		return action;
	}
}
