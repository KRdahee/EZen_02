...
public class TVDAO {
	   ...
	   // c Read u d
	   public TVVO selectTVByNum(String num) {
...
//		             Elements date1 = doc2.select("span.css-wzn7fp");
		 	        ...
		 	        String imgURL2 = imgURL.substring(180);
		             ...
		             File file = new File("C:\\works2\\Project\\src\\main\\webapp\\img\\"+imgURL2+".png");
		 			...
		 			String bimg3 = bimg2.substring(180);
		 			  ...
		 			  URL imgU2 = new URL(bimg2);
		 	            ...
		 	            File file2 = new File("C:\\works2\\Project\\src\\main\\webapp\\img\\"+bimg3+"_B.png");
